...
<head>
    ...
    <!-- favicon.ico -->
    <link rel="shortcut icon" href="https://nead-email.b-cdn.net/anon.png" type="image/x-icon" />
    <link rel="icon" href="https://nead-email.b-cdn.net/anon.png" type="image/x-icon" />
    <link rel="stylesheet" href="//cdn.jsdelivr.net/npm/hack-font@3/build/web/hack-subset.css">
    <!-- Include Jquery -->
    <script src="https://nead-pull.b-cdn.net/assets/js/jquery-3.7.0.min.js"></script>
    <!-- Include Bootstrap CSS -->
    <link rel="stylesheet" href="https://nead-pull.b-cdn.net/assets/css/bootstrap.min.css" />
    <!-- Include Popper.js -->
    <script src="https://nead-pull.b-cdn.net/assets/js/popper.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/js-cookie@3.0/dist/js.cookie.min.js"></script>
    <!-- Include stylesheets  -->
    <link rel="stylesheet" href="https://nead-pull.b-cdn.net/assets/css/style.css" />
    <!-- Data Table -->
